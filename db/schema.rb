...
ActiveRecord::Schema.define(version: 20160719160539) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["friend_id"], name: "index_messages_on_friend_id", using: :btree
  ...
  create_table "rejections", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["friend_id"], name: "index_rejections_on_friend_id", using: :btree
    t.index ["user_id"], name: "index_rejections_on_user_id", using: :btree
  end
